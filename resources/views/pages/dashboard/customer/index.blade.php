    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body d-flex justify-content-between">
          <a href="{{ route('dashboard.customer.create') }}" class="btn btn-primary"><i class="fas fa-plus"
              aria-hidden="true"></i> Tambah Data</a>
          <a href="{{ route('dashboard.print.customer') }}" class="btn btn-dark"><i class="fas fa-file-pdf"
            ...
            <table class="table table-striped" id="table-1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('dashboard.customer.show', $customer->id) }}" class="btn btn-info"><i
                        class="fa fa-eye" aria-hidden="true"></i></a>
                    <a href="{{ route('dashboard.customer.edit', $customer->id) }}" class="btn btn-warning"><i
