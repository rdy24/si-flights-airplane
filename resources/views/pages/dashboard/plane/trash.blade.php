...
@section('title')
Trashed Pesawat | {{ config('app.name') }}
@endsection
            ...
            <table class="table table-striped" id="table-1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $plane->kuota }}</td>
                  <td>
                    <a href="{{ route('dashboard.restore.plane', $plane->id) }}" class="btn btn-success btn-restore"><i
                        class="fa fa-trash-restore" aria-hidden="true"></i></a>
                    <a href="{{ route('dashboard.delete.plane', $plane->id) }}" class="btn btn-danger btn-delete"><i
...
<script>
  $('.btn-restore').on('click', function (e) {
    ...
    swal({
      title: 'Are you sure?',
      text: 'Data akan kembali ke daftar pesawat',
      icon: 'warning',
      buttons: ["Cancel", "Yes!"],
    }).then(function(value) {
      if (value) {
