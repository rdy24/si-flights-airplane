...
<div class="section-body">
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          <form action="{{ route('dashboard.plane.update', $plane->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="kode_pesawat" name="kode_pesawat" required
                value="{{ old('kode_pesawat', $plane->kode_pesawat) }}">
              @error('kode_pesawat')
              <p class="text-danger">
                {{ $message }}
              </p>
            ...
            <div class="form-group">
              ...
              <select name="airline_id" required class="form-control select2">
                ...
                <option value="{{ $airline->id }}" {{ old('airline_id', $plane->airline_id)==$airline->id ? 'selected' :
                  '' }}>
                  {{ $airline->nama }}
                </option>
                @endforeach
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control datepicker" id="tanggal_pembuatan" name="tanggal_pembuatan"
                required value="{{ old('tanggal_pembuatan', $plane->tanggal_pembuatan) }}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control datepicker" id="tanggal_operasional" name="tanggal_operasional"
                required value="{{ old('tanggal_operasional', $plane->tanggal_operasional) }}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control datepicker" id="tanggal_kadaluarsa" name="tanggal_kadaluarsa"
                required value="{{ old('tanggal_kadaluarsa', $plane->tanggal_kadaluarsa) }}">
            ...
            <div class="form-group">
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="status" id="status" value="Siap Terbang" {{
                  old('status', $plane->status)=='Siap Terbang' ? 'checked' :
                '' }}>
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="status" id="status1" value="Dalam Perawatan" {{
                  old('status', $plane->status)=='Dalam Perawatan' ? 'checked' :
                '' }}>
            ...
            <div class="form-group">
              ...
              <img class="img-preview img-fluid mb-3 col-sm-5 d-block"
                src="{{ $plane->gambar ? asset('storage/' . $plane->gambar) : '' }}">
