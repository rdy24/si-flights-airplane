...
@section('title')
Edit Kursi Pesawat | {{ config('app.name') }}
@endsection
...
<div class="section-body">
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          <form action="{{ route('dashboard.airplane_seat.update', $airplane_seat->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="form-group">
              ...
              <select name="plane_id" required class="form-control select2">
                ...
                <option value="{{ $plane->id }}" {{ old('plane_id', $airplane_seat->plane_id)==$plane->id ? 'selected' :
                  '' }}>
                  {{ $plane->nama }}
                </option>
                @endforeach
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="kuota" name="kuota" required
                value="{{ old('kuota', $airplane_seat->kuota) }}">
              @error('kuota')
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="harga" name="harga" required
                value="{{ old('harga', $airplane_seat->harga) }}">
              @error('harga')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
            ...
            <div class="form-group">
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="kelas_kursi" id="ekonomi" value="Ekonomi" {{
                  old('kelas_kursi', $airplane_seat->kelas_kursi)=='Ekonomi' ? 'checked' : '' }}>
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="kelas_kursi" id="bisnis" value="Bisnis" {{
                  old('kelas_kursi', $airplane_seat->kelas_kursi)=='Bisnis' ? 'checked' : '' }}>
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="kelas_kursi" id="first" value="First" {{
                  old('kelas_kursi', $airplane_seat->kelas_kursi)=='First' ? 'checked' : '' }}>
